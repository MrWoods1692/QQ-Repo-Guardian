...
pub fn render_member_card_svg(card: &MemberCard) -> String {
  ...
  <circle cx="138" cy="188" r="54" fill="{}"/>
  ...
  <text x="222" y="236" fill="#334155" font-family="Noto Sans CJK SC, Inter, Segoe UI, Arial, sans-serif" font-size="18" font-weight="750">QQ 号：{}</text>
  <text x="222" y="266" fill="#334155" font-family="Noto Sans CJK SC, Inter, Segoe UI, Arial, sans-serif" font-size="18" font-weight="750">群号：{}</text>
  <text x="438" y="236" fill="#64748b" font-family="Noto Sans CJK SC, Inter, Segoe UI, Arial, sans-serif" font-size="16" font-weight="650">类型：{}</text>
  <text x="438" y="266" fill="#64748b" font-family="Noto Sans CJK SC, Inter, Segoe UI, Arial, sans-serif" font-size="16" font-weight="650">操作者：{}</text>
</svg>"##,
        accent,
        soft,
        accent,
